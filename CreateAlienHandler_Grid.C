...
AliAnalysisGrid* CreateAlienHandler_Grid(const char *runMode, TString GridDir, TString DataPattern, Int_t RunNumber, TString AliPhysicsVersion, Bool_t gridMerge)
{
  ...
  char outdirname[250];
  //sprintf(outdirname,"XeXe/LHC17n/muon_calo_pass2/%d",RunNumber); //without PS
  sprintf(outdirname,"PbPb2015/LHC15o/muon_calo_pass1/%d",RunNumber); //without PS
 ...
 // plugin->SetMergeExcludes("AliAOD.Muons.root");
  ...
  // added by me
  plugin->SetAnalysisSource("AliAnalysisTaskXeXeJPsiTree_Dimuon.cxx AliAnalysisTaskXeXeJPsi_Dimuon.cxx");
  plugin->SetAdditionalLibs("AliAnalysisTaskXeXeJPsiTree_Dimuon.cxx AliAnalysisTaskXeXeJPsiTree_Dimuon.h AddTaskXeXeJPsiTree_Dimuon_Grid.C AliAnalysisTaskXeXeJPsi_Dimuon.cxx AliAnalysisTaskXeXeJPsi_Dimuon.h AddTaskXeXeJPsi_Dimuon_Grid.C");
